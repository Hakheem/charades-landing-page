    ...
    <footer className="w-full mt-24 bg-white border-t-8 border-zine-ink p-10 md:p-16">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div className="flex flex-col gap-4">
          ...
          <p className="font-utility-mono text-sm text-zinc-500">
            © {currentYear} IGA CHARADES. <br/>
            Kazi kwa vijana.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-2">
          ...
          {['Home', 'Game Modes', 'How to Play', 'Download'].map((link) => (
            <a href={`#${link.toLowerCase().replace(' ', '-')}`} className="font-utility-mono text-sm hover:text-sheng-violet transition-colors">
              {link}
            </a>
          ))}
        </div>
        ...
        <div className="flex flex-col gap-2">
          ...
          <a href="mailto:hakheem.dev@gmail.com" className="font-utility-mono text-sm hover:text-sheng-violet transition-colors">hello@iga.co.ke</a>
