...
export default function Navbar() {
  return (
    <nav className="w-full sticky top-0 z-50 bg-white border-b-4 border-zine-ink flex justify-between items-center px-6 py-5">
      {/* Brand Logo */}
      <div className="font-display-xl text-2xl text-zine-ink border-2 border-zine-ink px-3 py-1 cursor-pointer">
        IGA
      </div>
